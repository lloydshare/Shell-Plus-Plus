...
//    {
//        int selectedIndex = 0;
//        int windowHeight = Terminal.WindowHeight() - 4;
...
namespace Core.SystemTools
{
    ...
    public class ProcessListingUI
    {
        ...
        public void Run()
        {
            ...
            //var sampleThread = new Thread(SampleLoop) { IsBackground = true };
