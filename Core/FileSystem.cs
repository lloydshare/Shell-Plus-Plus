...
namespace Core
{
    ...
    public class FileSystem
    {
        ...
        public static void WriteError(String Class, String Method, String ErrorMessage)
        {
        ...
        public static void ColorConsoleTextLine(ConsoleColor color, string text)
        {
            ...
            // Save current color
            Color currentColor = Terminal.GetConsoleTextColor();

            // Convert ConsoleColor → System.Drawing.Color
            Color winColor = ConsoleColorToDrawingColor(color);

            // Set new color
            Terminal.SetConsoleTextColor(winColor);

            // Write data
            Console.WriteLine(text);

            // Restore original color
            Terminal.SetConsoleTextColor(currentColor);
        }
        ...
        /// <param name="color"></param>
        /// <param name="text"></param>
        public static void ColorConsoleText(Color color, object data)
        {
            // Save current color
            Color currentColor = Terminal.GetConsoleTextColor();

            // Set new color
            Terminal.SetConsoleTextColor(color);
        ...
        private static readonly Dictionary<ConsoleColor, Color> ConsoleToDrawing = new()
        {
        ...
        public static Color ConsoleColorToDrawingColor(ConsoleColor color)
        {
