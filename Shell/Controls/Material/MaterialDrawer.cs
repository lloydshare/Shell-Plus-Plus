namespace MaterialSkin.Controls
{
    ...
    public class MaterialDrawer : Control, ISkin
    {
        ...
        private void preProcessIcons()
        {
            ...
            float l = UseColors ? SkinManager.TextColor.R / 255 : SkinManager.Theme == SkinManager.Themes.LIGHT ? 0f : 1f;
            float r = (_highlightWithAccent ? SkinManager.BorderColor.R : SkinManager.PrimaryColor.R) / 255f;
            float g = (_highlightWithAccent ? SkinManager.BorderColor.G : SkinManager.PrimaryColor.G) / 255f;
            float b = (_highlightWithAccent ? SkinManager.BorderColor.B : SkinManager.PrimaryColor.B) / 255f;
        ...
        protected override void InitLayout()
        {
            ...
            drawerItemHeight = (TAB_HEADER_PADDING * 2) / 2;
            //MinWidth = (int)(SkinManager.FORM_PADDING * 1.5 + drawerItemHeight);
            MinWidth = (int)(drawerItemHeight);
        ...
        private new void Paint(PaintEventArgs e)
        {
            ...
            // redraw stuff
            g.Clear(UseColors ? SkinManager.PrimaryColor : SkinManager.BackdropColor);
            ...
            if (_clickAnimManager.IsAnimating())
            {
                var rippleBrush = new SolidBrush(Color.FromArgb((int)(70 - (clickAnimProgress * 70)),
                    UseColors ? SkinManager.BorderColor : // Using colors
                    SkinManager.PrimaryColor));// : // light theme
            ...
            g.FillRectangle(SkinManager.BackgroundFocusBrush, x, y, IndicatorWidth, height);
        }
